...
export namespace Prisma {
  ...
  */
  ...
  export type StudentsOmit<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = $Extensions.GetOmit<"rollno" | "name" | "gender" | "class" | "bloodgrp", ExtArgs["result"]["students"]>
  ...
  export interface StudentsDelegate<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs, GlobalOmitOptions = {}> {
     ...
     * 
     * // Only select the `rollno`
     * const studentsWithRollnoOnly = await prisma.students.findMany({ select: { rollno: true } })
     * 
     */
     ...
     * })
     * 
     * // Create many Students and only return the `rollno`
     * const studentsWithRollnoOnly = await prisma.students.createManyAndReturn({
     *   select: { rollno: true },
     *   data: [
     *     // ... provide data here
     *   ]
     ...
     * })
     * 
     * // Update zero or more Students and only return the `rollno`
     * const studentsWithRollnoOnly = await prisma.students.updateManyAndReturn({
     *   select: { rollno: true },
     *   where: {
     *     // ... provide filter here
     *   },
  ...
  export type StudentsScalarWhereWithAggregatesInput = {
    ...
    rollno?: StringWithAggregatesFilter<"Students"> | string
    ...
    bloodgrp?: StringWithAggregatesFilter<"Students"> | string
  }
  ...
  export type StudentsUpdateInput = {
    ...
    bloodgrp?: StringFieldUpdateOperationsInput | string
  }
